      ...
      <div className={styles.container}>
        ...
        >
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            La <strong>amigable composición en Colombia</strong> es un mecanismo
            alternativo de solución de conflictos mediante el cual las partes
            delegan en un tercero denominado{" "}
            ...
            conflictos empresariales en ciudades como Bogotá y en toda Colombia.
          </motion.p>
          ...
          >
            ...
            contractual en Colombia. Esto significa que nace del acuerdo de las
            partes, quienes establecen el procedimiento, el alcance de la
          ...
          >
            ...
            Colombia porque permite resolver conflictos de forma más rápida que
            un proceso judicial y con la intervención de un experto en el tema
            del conflicto.
          </motion.p>
          ...
          >
            ...
            <li>
              <strong>Flexibilidad:</strong> el procedimiento es más ágil que un
              proceso judicial.
            </li>
            <li>
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            En la <strong>conciliación en Colombia</strong> las partes negocian
            y construyen el acuerdo con la ayuda de un conciliador. En la{" "}
            <strong>amigable composición en Colombia</strong>, en cambio, las
            partes delegan en un tercero la decisión final del conflicto.
          </motion.p>
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Diferencia rápida: en conciliación las partes construyen el acuerdo;
            en amigable composición, un tercero define la solución dentro del
            marco pactado por las partes.
          </motion.p>
          ...
          >
            ...
            <li>
              Cuando existe una cláusula de amigable composición en el contrato.
            </li>
