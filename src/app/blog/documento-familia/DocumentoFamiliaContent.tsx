      ...
      <div className={styles.container}>
        ...
        >
          ...
          <p className={styles.paragraph}>
            La <strong>conciliación familiar en Colombia</strong> es uno de los
            mecanismos más utilizados para resolver conflictos relacionados con{" "}
            <strong>alimentos, visitas, custodia y acuerdos de crianza</strong>,
            especialmente en ciudades como <strong>Bogotá</strong>.
          </p>

          <p className={styles.paragraph}>
            Un <strong>acta de conciliación familiar</strong> bien estructurada
            no solo evita conflictos futuros, sino que también tiene{" "}
            <strong>validez legal</strong> y puede ser exigida en caso de
            incumplimiento.
          </p>
          ...
          <div className={styles.note}>
            ...
            específicos y medibles. Evita frases ambiguas como “cuando se pueda”
