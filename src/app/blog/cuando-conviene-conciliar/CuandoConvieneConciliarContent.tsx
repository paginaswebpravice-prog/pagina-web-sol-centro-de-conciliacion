    ...
    <section id="cuando-conviene" className={styles.articleWrapper}>
      ...
      >
        ...
        <p className={styles.paragraph}>
          La <strong>conciliación en Colombia</strong> es uno de los mecanismos
          más eficientes para resolver conflictos sin acudir a un proceso
          judicial. En ciudades como <strong>Bogotá</strong>, donde los tiempos
          judiciales pueden ser largos, la conciliación se convierte en una
          herramienta estratégica para lograr acuerdos rápidos y efectivos.
        </p>
        ...
        <ul className={styles.list}>
          <li>Cuando una de las partes no tiene intención real de negociar.</li>
          <li>Cuando se requiere una decisión judicial obligatoria.</li>
          <li>Cuando hay derechos no conciliables según la ley colombiana.</li>
        </ul>
        ...
        <div className={styles.cta}>
          ...
          <p className={styles.paragraph}>
            ...
            Colombia, lo más importante es llegar con una propuesta clara:
