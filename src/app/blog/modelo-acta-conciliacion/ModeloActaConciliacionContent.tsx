  ...
  return (
    ...
    >
      ...
      <motion.p className={styles.modeloText}>
        ...
        encontrarás un ejemplo general que puede utilizarse como referencia para
        conciliaciones civiles, comerciales o de conflictos entre particulares.
        ...
        por escrito el acuerdo al que llegan las partes para resolver un
        conflicto sin necesidad de un proceso judicial.
      </motion.p>
      ...
      <motion.p className={styles.modeloNote}>
        Importante: en Colombia, el acta de conciliación tiene efectos legales y
        puede prestar mérito ejecutivo. Por eso es importante que las
...
Parte B: ___________________________`}
      ...
      <motion.p className={styles.modeloText}>
        Muchas personas en Bogotá y en toda Colombia buscan modelos de actas de
        conciliación para resolver conflictos de deudas, contratos,
      ...
      <motion.p className={styles.modeloText}>
        Antes de firmar un acta de conciliación, es recomendable revisar que las
        obligaciones sean posibles de cumplir, que los plazos sean claros y que
        exista una forma de demostrar el cumplimiento. Un buen acuerdo evita
        futuros conflictos y permite cerrar el problema de manera definitiva.
      </motion.p>
    </motion.article>
  );
}
