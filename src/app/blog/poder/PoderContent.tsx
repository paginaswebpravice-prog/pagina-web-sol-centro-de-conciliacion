  ...
  return (
    <div className={styles.wrapper}>
      <div className={styles.container}>
        ...
        >
          <h2>
            Poder para asistir a audiencia de conciliación en Colombia (modelo)
          </h2>

          <p>
            El poder para asistir a audiencia de conciliación en Colombia es un
            documento mediante el cual una persona autoriza a un abogado o
            ...
            conciliación en Bogotá y en todo Colombia cuando la persona no puede
            asistir personalmente a la audiencia.
          </p>

          <p>
            En Colombia, la conciliación es un mecanismo alternativo de solución
            de conflictos mediante el cual las partes pueden llegar a un acuerdo
            sin necesidad de iniciar un proceso judicial. Por esta razón, muchas
            personas otorgan un poder especial para conciliación para que un
            abogado o apoderado pueda asistir a la audiencia, negociar acuerdos,
            presentar documentos y firmar el acta de conciliación.
          </p>
