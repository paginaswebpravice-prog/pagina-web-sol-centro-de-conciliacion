    ...
    <section className={styles.wrapper}>
      ...
      >
        ...
        <motion.p className={styles.text}>
          ...
          es un documento legal mediante el cual dos personas que conforman una
          <strong> unión marital de hecho</strong> pueden establecer acuerdos
          sobre obligaciones económicas, convivencia, gastos del hogar, acuerdos
          respecto de hijos, custodia, visitas, alimentos y reparto de
          responsabilidades.
        </motion.p>
        ...
        <motion.h2 className={styles.subTitle}>
          ¿Para qué sirve un acta de conciliación entre compañeros permanentes?
        </motion.h2>

        <motion.p className={styles.text}>
          Este documento sirve para dejar por escrito acuerdos relacionados con:
        </motion.p>
        ...
        <motion.p className={styles.text}>
          Para realizar una conciliación entre compañeros permanentes en Bogotá
          o en cualquier parte de Colombia, normalmente se requiere:
        </motion.p>
...
Firmas…`}
        ...
        <motion.p className={styles.text}>
          En Colombia, las actas de conciliación tienen efectos legales y pueden
          ser ejecutadas judicialmente en caso de incumplimiento. Por esta
          razón, es importante que el acuerdo sea claro, específico y que
          establezca montos, fechas y obligaciones concretas.
        </motion.p>

        <motion.p className={styles.text}>
          Si necesita realizar una conciliación entre compañeros permanentes en
          Bogotá o en cualquier ciudad de Colombia, es recomendable recibir
