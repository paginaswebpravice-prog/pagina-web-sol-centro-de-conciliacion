    ...
    <section id="errores" className={styles.section}>
      <div className={styles.container}>
        ...
        >
          ...
          entre empleadores y trabajadores sin necesidad de llegar a un proceso
          judicial. Sin embargo, muchas personas cometen errores durante la
          audiencia de conciliación que pueden afectar el acuerdo final, los
          pagos, las indemnizaciones o incluso sus derechos laborales.
        </motion.p>
        ...
        >
          <ul className={styles.list}>
            ...
            >
              <span>
                <strong>Llegar sin propuesta económica:</strong> Muchas personas
                asisten a la conciliación sin tener claro cuánto dinero van a
                solicitar, cómo se debe pagar o en qué plazos. Siempre es
                recomendable llevar una propuesta clara con valores, fechas y
                forma de pago.
              </span>
            </motion.li>
            ...
            >
              <span>
                <strong>Actas ambiguas o incompletas:</strong> Si el acuerdo no
                establece claramente valores, fechas de pago y forma de
                cumplimiento, el acuerdo puede generar nuevos conflictos legales
                en el futuro.
              </span>
            </motion.li>
        ...
        >
          ...
          liquidaciones, indemnizaciones y valores reales para lograr un acuerdo
          justo y legal.
        </motion.p>
      </div>
    </section>
