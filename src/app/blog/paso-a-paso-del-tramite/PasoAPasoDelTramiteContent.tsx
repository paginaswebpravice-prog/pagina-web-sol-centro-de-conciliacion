    ...
    <section id="paso-a-paso" className={styles.articleWrapper}>
      ...
      >
        ...
        <p className={styles.paragraph}>
          ...
          solucionar disputas civiles, comerciales, familiares e incluso algunos
          conflictos laborales de forma ágil.
        </p>

        <p className={styles.paragraph}>
          A continuación te explicamos el paso a paso de una conciliación en
          Colombia, desde la solicitud hasta la firma del acta de conciliación,
          para que entiendas cómo funciona este trámite y cómo prepararte
          correctamente.
        </p>

        <ol className={styles.orderedList}>
          <li>
            <strong>Solicitud de conciliación:</strong> debes presentar tu caso
            ante un centro de conciliación en Bogotá o en cualquier ciudad de
            Colombia, explicando qué ocurrió, qué solicitas y cuáles son tus
            pretensiones.
          </li>

          <li>
            <strong>Revisión y admisión:</strong> el centro de conciliación
            verifica que el caso sea conciliable, revisa la información básica y
            valida que se cumplan los requisitos legales.
          </li>
          ...
          <li>
            <strong>Resultado del trámite:</strong> si hay acuerdo, se firma un
            acta de conciliación con efectos legales. Si no hay acuerdo, se
        ...
        <p className={styles.paragraph}>
          El tiempo de una conciliación en Colombia puede variar dependiendo del
          caso y de la disponibilidad del centro de conciliación en Bogotá. Sin
          embargo, muchos procesos pueden resolverse en una sola audiencia si
          las partes llegan preparadas y con disposición para negociar.
        </p>
        ...
        <p className={styles.paragraph}>
          ...
          autorizados, notarías, cámaras de comercio y consultorios jurídicos en
          Bogotá y en todo Colombia. También existen opciones de conciliación
          virtual que facilitan el acceso al servicio.
        </p>
