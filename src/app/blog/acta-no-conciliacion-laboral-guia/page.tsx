...
export const metadata: Metadata = {
  title:
    "Acta de no conciliación laboral en Colombia | Qué es y para qué sirve",
  description:
    "Conoce qué es un acta de no conciliación laboral en Colombia, cuándo se emite, cuáles son sus efectos y qué opciones tiene el trabajador después de una audiencia sin acuerdo.",
  keywords: [
    "acta de no conciliacion laboral",
