    ...
    <section id="acta" className={styles.section}>
      <div className={styles.container}>
        ...
        >
          ...
          acuerdo que queda allí escrito tiene <strong>efectos legales</strong>{" "}
          y puede exigirse judicialmente si no se cumple.
        </motion.p>
        ...
        <motion.p className={styles.paragraph}>
          ...
          parte puede iniciar un <strong>proceso ejecutivo</strong> ante un juez
          para exigir el pago o el cumplimiento de la obligación. Esto significa
          que el juez puede ordenar embargos, pagos o cumplimiento de lo
          pactado.
        </motion.p>
        ...
        <motion.div className={styles.note}>
          ...
          antes posible”. En Colombia, las obligaciones deben tener fecha, valor
          y forma de cumplimiento para que el acta pueda ejecutarse.
        </motion.div>
